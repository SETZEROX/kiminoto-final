            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="<?= base_url('Backend/rule_update/'.$rule[0]->id); ?>" method="POST">
                                ชื่อหัวข้อ
                                    <input class="form-control" name="title" value="<?= $rule[0]->title; ?>" placeholder="ชื่อหัวข้อ">
                                    <br>
                                    รายละเอียด
                                    <textarea name="editor1"><?= $rule[0]->detail; ?></textarea>
                                    <hr>
