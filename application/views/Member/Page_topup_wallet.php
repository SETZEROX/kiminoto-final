                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <form onSubmit='post_ajax("<?= base_url('Topup/wallet'); ?>",$(this).serialize());return false;' method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="telephone" id="telephone" placeholder="กรุณาใส่เบอร์ที่ใช้โอนเงิน" type="number" required>
                                            </div>
                                            <div class="form-group">
                                                <label>กรุณาใส่จำนวนที่โอน</label>
                                                <input class="form-control" name="amount" id="amount" placeholder="กรุณาใส่จำนวนที่โอน" type="number" required>
                                            </div>
                                            <div class="form-group">
                                                <?php
