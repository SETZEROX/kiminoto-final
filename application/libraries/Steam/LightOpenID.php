...
class LightOpenID
{
    ...
    function login($host, $proxy = null)
    {
        $this->set_realm($host);
    ...
    protected function request_curl($url, $method='GET', $params=array(), $update_claimed_id = NULL)
    {
    ...
    protected function parse_header_array($array, $update_claimed_id = NULL)
    {
        $headers = array();
    ...
    protected function request_streams($url, $method='GET', $params=array(), $update_claimed_id = NULL)
    {
